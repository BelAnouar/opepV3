<div class=" px-3 pt-2 mb-[2.9rem]">
    <header class="z-40   w-full h-16 bg-white shadow-xl border border-black/5 rounded-2xl sticky top-0 scroll-sm">
        <div class=" z-20 flex flex-col justify-center h-full px-3  items-center">
            <div class="  w-full pl-1 lg:max-w-68 sm:pr-2 sm:ml-0">
                <div class=" left-0 z-50 flex justify-between  h-full">
                    <h1 class="pr-4">Dashboard</h1>
                    <div class=" flex items-center cursor-pointer ">
                        <svg id="userIcon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="user w-6 h-6 hover:shadow-xl ">
                    ...
                    <div id="dropdownContent" class="hidden absolute right-4 mt-9  w-62.5  rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
