    ...
    <div class="flex ">
        <div class=' w-1/5 h-screen p-4 bg-white border-r border-gray-300 flex flex-col justify-between'>
            <div class="flex flex-col items-center">
                ...
                <a href="./../order.php" class="bg-gray-100 text-gray-800 my-2 p-3 rounded-lg inline-block">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <a href="/profile" class="bg-gray-100 text-gray-800 my-2 p-3 rounded-lg inline-block">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
